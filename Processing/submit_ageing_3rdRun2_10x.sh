...
## submit a 10X cell ranger job for the ageing ZsGreen-lineage tracing experiment 3rd sample run 2
LOG="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/logs/Ageing_10X_ZsG"
SRCDIR="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/src"

HTO_LIBFILE="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/lib_files/AgeingExperiment_3rd_Run2_HTO.tsv"  
ADT_LIBFILE="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/lib_files/AgeingExperiment_3rd_Run2_ADT.tsv"

ADT_REFLIB="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/refs/Ageing_3rd_Run2_ADT_refs.tsv"
HTO_REFLIB="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/refs/Ageing_3rd_Run2_HTO_refs.tsv"

# I need to run the feature barcoding for the CITE-seq antibodies and hashtags separately

ADT_ID="Ageing_ZsG_3rdRun2_ADT"
HTO_ID="Ageing_ZsG_3rdRun2_HTO"
