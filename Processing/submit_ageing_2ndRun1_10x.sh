...
## submit a 10X cell ranger job for the ageing ZsGreen-lineage tracing experiment 2nd sample run 1
LOG="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/logs/Ageing_10X_ZsG"
SRCDIR="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/src"

HTO_LIBFILE="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/lib_files/AgeingExperiment_2nd_Run1_HTO.tsv"  
ADT_LIBFILE="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/lib_files/AgeingExperiment_2nd_Run1_ADT.tsv"

ADT_REFLIB="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/refs/Ageing_2nd_Run1_ADT_refs.tsv"
HTO_REFLIB="/nfs/research1/marioni/mdmorgan/Thymus_ZsG/refs/Ageing_2nd_Run1_HTO_refs.tsv"

# I need to run the feature barcoding for the CITE-seq antibodies and hashtags separately

ADT_ID="Ageing_ZsG_2ndRun1_ADT"
HTO_ID="Ageing_ZsG_2ndRun1_HTO"
