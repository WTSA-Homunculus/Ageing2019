...
permanova.meta <- permanova.meta[permanova.meta$TFIDF.Cluster %in% select.cluster, ]
...
for(i in seq_along(valid.genes)){
  ...
  gene.permanova <- adonis(gene.dist ~ AgeFactor, data=permanova.meta)
